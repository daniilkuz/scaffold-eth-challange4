...
contract DEX {
  ...
  function deposit() public payable returns (uint256 tokensDeposited) {
    ...
    require(token.transferFrom(msg.sender, address(this), tokenDeposit), "deposit() failed to transfer tokens from the caller");
  ...
  function withdraw(uint256 amount) public returns (uint256 eth_amount, uint256 token_amount) {
    ...
    require(token.transfer(msg.sender, token_amount), "withdraw(): failed to send tokens to the caller");
